...
_RAW = [
    (  1,  '阿根廷',              802,    7.2,  8.0,  6.0,  7.1,  'B+'),
    (  2,  '西班牙',             1268,    9.2,  9.0,  8.4,  8.9,  'S'),
    (  3,  '法国',              1556,    9.9,  9.5,  9.3,  9.6,  'S'),
    (  4,  '英格兰',             1011,    9.4,  9.5,  6.4,  8.6,  'S'),
    (  5,  '葡萄牙',              966,    8.7,  9.0,  9.1,  8.9,  'S'),
    (  6,  '巴西',               909,    8.6,  8.0,  8.2,  8.3,  'A'),
    (  7,  '摩洛哥',              470,    4.5,  6.5,  5.2,  5.4,  'C'),
    (  8,  '荷兰',               839,    7.1,  7.0,  8.6,  7.5,  'A'),
    (  9,  '比利时',              573,    7.1,  7.5,  5.8,  6.8,  'B+'),
    ( 10,  '德国',               988,    6.6,  8.5,  7.8,  7.6,  'A'),
    ( 11,  '克罗地亚',             362,    6.3,  7.5,  6.5,  6.8,  'B+'),
    ...
    ( 22,  '土耳其',              473,    6.1,  8.0,  4.7,  6.3,  'B'),
    ( 23,  '厄瓜多尔',             366,    5.1,  7.5,  5.8,  6.2,  'B'),
