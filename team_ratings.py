...
_RAW = [
    (  1,  '阿根廷',              802,    7.2,  8.0,  6.7,  7.3,  'B+'),
    (  2,  '西班牙',             1268,    9.2,  9.0,  8.8,  9.0,  'S'),
    (  3,  '法国',              1556,    9.9,  9.5,  9.3,  9.6,  'S'),
    (  4,  '英格兰',             1011,    9.4,  9.5,  7.1,  8.8,  'S'),
    (  5,  '葡萄牙',              966,    8.7,  9.0,  9.1,  8.9,  'S'),
    (  6,  '巴西',               909,    8.6,  8.0,  8.6,  8.4,  'A'),
    (  7,  '摩洛哥',              470,    4.5,  6.5,  5.2,  5.4,  'C'),
    (  8,  '荷兰',               839,    7.1,  7.0,  9.0,  7.6,  'A'),
    (  9,  '比利时',              573,    7.1,  7.5,  6.5,  7.1,  'B+'),
    ( 10,  '德国',               988,    6.6,  8.5,  8.2,  7.7,  'A'),
    ( 11,  '克罗地亚',             362,    6.3,  7.5,  7.2,  7.0,  'B+'),
    ( 13,  '哥伦比亚',             301,    5.5,  6.5,  3.6,  5.3,  'C'),
    ( 14,  '墨西哥',              194,    3.9,  6.5,  3.2,  4.6,  'C'),
    ( 15,  '塞内加尔',             290,    6.4,  6.0,  3.8,  5.5,  'B'),
    ( 16,  '乌拉圭',              484,    5.9,  7.5,  5.0,  6.2,  'B'),
    ( 17,  '美国',               372,    4.9,  6.5,  3.7,  5.1,  'C'),
    ( 18,  '日本',               279,    5.0,  7.0,  4.6,  5.6,  'B'),
    ( 19,  '瑞士',               333,    4.5,  7.0,  5.2,  5.6,  'B'),
    ( 20,  '伊朗',                33,    2.6,  5.0,  0.5,  2.8,  'D'),
    ( 22,  '土耳其',              473,    6.1,  8.0,  5.4,  6.5,  'B+'),
    ( 23,  '厄瓜多尔',             366,    5.1,  7.5,  6.5,  6.4,  'B'),
    ( 24,  '奥地利',              258,    5.9,  7.5,  3.4,  5.7,  'B'),
    ( 25,  '韩国',               140,    4.6,  7.0,  3.1,  5.0,  'C'),
    ( 27,  '澳大利亚',              72,    3.3,  5.5,  3.1,  4.0,  'C'),
    ( 28,  '阿尔及利亚',            258,    4.6,  6.0,  4.2,  5.0,  'C'),
    ( 29,  '埃及',               124,    6.0,  5.5,  1.8,  4.6,  'C'),
    ( 30,  '加拿大',              204,    4.2,  6.0,  4.7,  5.0,  'C'),
    ( 31,  '挪威',               471,    7.6,  7.0,  3.5,  6.2,  'B'),
    ( 33,  '科特迪瓦',             515,    5.6,  2.0,  5.9,  4.4,  'C'),
    ( 34,  '巴拿马',               26,    1.0,  4.5,  1.6,  2.4,  'D'),
    ( 38,  '瑞典',               369,    7.2,  5.5,  4.7,  5.9,  'B'),
    ( 40,  '捷克',               190,    3.8,  6.0,  4.3,  4.7,  'C'),
    ( 41,  '巴拉圭',              157,    3.0,  5.5,  3.1,  3.9,  'D'),
    ( 42,  '苏格兰',              208,    4.3,  6.0,  3.5,  4.7,  'C'),
    ( 45,  '突尼斯',               68,    3.4,  4.5,  1.8,  3.3,  'D'),
    ( 46,  '刚果(金)',            131,    2.6,  4.0,  3.6,  3.4,  'D'),
    ( 50,  '乌兹别克斯坦',            70,    2.3,  4.5,  4.1,  3.6,  'D'),
    ( 56,  '卡塔尔',               20,    2.6,  5.0,  0.5,  2.8,  'D'),
    ( 57,  '伊拉克',               24,    2.1,  4.0,  0.5,  2.3,  'D'),
    ( 60,  '南非',                45,    2.4,  4.0,  2.0,  2.8,  'D'),
    ( 61,  '沙特阿拉伯',             37,    3.2,  5.0,  1.8,  3.4,  'D'),
    ( 63,  '约旦',                20,    2.2,  3.5,  0.5,  2.1,  'D'),
    ( 64,  '波黑',               139,    3.5,  5.0,  3.1,  3.9,  'D'),
    ( 67,  '佛得角',               35,    1.7,  3.5,  1.9,  2.4,  'D'),
    ( 73,  '加纳',               200,    5.5,  5.5,  2.6,  4.6,  'C'),
    ( 82,  '库拉索',               25,    1.7,  2.0,  0.5,  1.4,  'D'),
    ( 83,  '海地',                56,    2.8,  3.5,  0.5,  2.3,  'D'),
    ( 85,  '新西兰',               38,    2.1,  4.0,  2.0,  2.7,  'D'),
]
