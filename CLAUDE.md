# 世界杯预测模型 V3.19 (回测 29/29=100%)

> 📅 2026-06-21 · 球员DB 1250人/48队·intl_caps 82%覆盖 · 29场回测 · 决策树十条路径全部验证 · 方向-泊松冲突检测 · xG软约束
...
⑩ 理性热度: BIG + 冷热<20 + 市场隐含>85% → 热门胜(理性热度) ← V3.19

🆕 V3.18: 实力优先覆盖home_is_strong·跳过Poisson均值回拨
🆕 V3.19: BIG无过热精细化·xG>4.0软约束·冷热18-22模糊带
```
...
| V3.18 | 06-21 | 实力优先覆盖home_is_strong·Poisson均值回拨跳过·冷热bug修复(客热值正确显示) |
| V3.19 | 06-21 | BIG无过热理性热度·xG>4.0软约束·冷热18-22模糊带·十条路径完整 |
